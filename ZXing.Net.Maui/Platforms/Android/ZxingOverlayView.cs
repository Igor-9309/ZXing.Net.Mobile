...
namespace ZXing.Net.Maui.Platforms.Android
{
    ...
    {
        readonly int[] SCANNER_ALPHA = { 0, 64, 128, 192, 255, 192, 128, 64 };
        ...
        static Rect GetFramingRect(Canvas canvas)
        {
        ...
        protected override void OnDraw(Canvas canvas)
        {
            ...
            var topTextLayout = new StaticLayout(TopText, textPaint, canvas.Width, Text.Layout.Alignment.AlignCenter, 1.0f, 0.0f, false);
            canvas.Save();
            ...
            var botTextLayout = new StaticLayout(BottomText, textPaint, canvas.Width, Text.Layout.Alignment.AlignCenter, 1.0f, 0.0f, false);
            canvas.Save();
