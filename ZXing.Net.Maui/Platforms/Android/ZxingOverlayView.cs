...
namespace ZXing.Net.Maui.Platforms.Android
{
	public class ZxingOverlayView : View
	{
		...
		protected override void OnDraw(Canvas canvas)
		{
			...
			var topTextLayout = new StaticLayout(this.TopText, textPaint, canvas.Width, Text.Layout.Alignment.AlignCenter, 1.0f, 0.0f, false);
			canvas.Save();
			...
			var botTextLayout = new StaticLayout(this.BottomText, textPaint, canvas.Width, Text.Layout.Alignment.AlignCenter, 1.0f, 0.0f, false);
			canvas.Save();
